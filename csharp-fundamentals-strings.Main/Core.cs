...
namespace csharp_fundamentals_strings.Main
{
    public class Core
    {
        ...
        // Using the `replace` method on brokenUrl, set the fixedUrl member below to return the correct value.

        public string fixedUrl { get { return brokenUrl.Replace("z", "s"); } }
        ...
        public string faqUrl => $"{this.protocol}://{this.domain}/faq";
    }
}
